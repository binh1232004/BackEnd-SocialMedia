...
public class MessageService : IMessageService
{
    ...
    public async Task<MessageResponseDto> SendMessage(string senderId, SendMessageDto messageDto)
    {
        ...
        var message = new message
        {
            ...
            group_chat_id = messageDto.GroupChatId,
            content = messageDto.Content,
            media_type = messageDto.MediaType,
