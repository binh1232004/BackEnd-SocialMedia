...
//     }
//
//     public async Task<GroupDto> CreateGroupAsync(GroupCreateDto groupDto, Guid userId)
//     {
//         try
//         {
//             if (groupDto.Visibility != "Public" && groupDto.Visibility != "Private")
//                 throw new ArgumentException("Visibility must be 'Public' or 'Private'.");
//
//             var group = (groupDto, userId).Adapt<Group>();
