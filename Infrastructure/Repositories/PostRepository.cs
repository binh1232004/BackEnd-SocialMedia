...
namespace Infrastructure.Repositories
{
    public class PostRepository : IPostRepository
    {
        ...
        public async Task<List<Post>> GetUserPostsAsync(Guid userId, int page, int pageSize)
        {
            ...
            Console.WriteLine($"Retrieved {posts.Count} user posts for user {userId}, page {page}, pageSize {pageSize}");
            return posts;
        }
        ...
        public async Task<List<Post>> GetGroupPostImgOfUsersAsync(Guid groupId, int page, int pageSize)
        {
            var posts = await _context.Posts
                .Include(p => p.User)
                .Include(p => p.Media)
